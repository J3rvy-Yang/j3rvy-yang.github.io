...
var resultList = [];
const quizdata = [{
    question: "A reduction in the value of an asset with the passage of time, due in particular to wear and tear.",
    options: ["Ciliation", "Deception", "Depreciation", "Emulation"],
    answer: "Depreciation",
    category: 1
}, {
    question: " A stock in a stock corporation with a national reputation for quality, reliability, and the ability to operate profitably in good and bad times.",
    options: ["Blue-chip", "Growth stocks", "Large-cap stocks", " Defensive Stocks"],
    answer: "Blue-chip",
    category: 2
}, {
    question: "Cryptocurrecys and NFTs run on _________ Technology",
    options: ["Alofe", "Binance", "Blockchain", "Ether"],
    answer: "Blockchain",
    category: 3
}, {
    question: "What is the max contribution allowed to be deposited in a Roth IRA",
    options: ["$7,250", "$5,500", "$6,000", "$8,000"],
    answer: "$6,000",
    category: 1
}, {
    question: "All of these are secured loans except",
    options: ["Car loans", "Mortgage", "Equity", "Credit"],
    answer: "Credit",
    category: 2
}, {
    question: "Using a debit card will effect your credit score and utilazation",
    options: ["Always", "Sometimes", "Depends", "Never"],
    answer: "Never",
    category: 3
}, {
    question: "The Federal Deposit Insurance Corporation will insure ________ per depositor",
    options: ["$650,000", "$120,500", "$250,000", "$525,500"],
    answer: "$250,000",
    category: 2
}, {
    question: "Bought by an investor and occupied by tenants under a lease ",
    options: ["Residential property", "Land", "Commerical property", "Residential rental property"],
    answer: "Residential rental property",
    category: 3
}, {
    question: "BRRRR stands for ",
    options: ["Buy, Refiance, Rent, rehab, Repeat", "Buy, Rehab, Rent, Refinance, Repeat", "Buy, Rent, Refiance, Rehab, Repeat", "Buy, Rent, Repeat, Rehab, Refiance"],
    answer: "Buy, Rehab, Rent, Refinance, Repeat",
    category: 1
}, {
    question: "Buy a lot of stock, hype it, and sell it after other investors find it attractive",
    options: ["Pump and Dump", "Hype and flight", "Boost and lose", "Pugg and tug"],
    answer: "Pump and Dump",
    category: 2
}, {
    question: "To build Credit, keep credit utilaztion ",
    options: ["Under 60%", "Under 45%", "Under 30%", "Under 50%"],
    answer: "Under 30%",
    category: 3
}, {
    question: "Stocks that give a distribution of a portion of a company's earnings to a class of shareholders chosen by the board of directors of the firm. ",
    options: ["Dividend stocks", "income stocks", "Pay stocks", "Distribution Stocks"],
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: ['rgba(239, 239, 81, 1)', '#8e3407', 'rgba((239, 239, 81, 1)', '#000000'],
                borderWidth: 1
            }]
        },
        options: {
...
function getAllAnswer(results) {
    ...
    for(var i = 0; i < results.length; i++) {
        ...
        var _html = '<div class="_resultboard ' + _class + '">' + '<div class="_header">' + results[i].question + '</div>' + '<div class="_yourans ' + _classH + '">' + results[i].clicked + '</div>';
        var html = "";
        if(!results[i].iscorrect) html = '<div class="_correct">' + results[i].answer + '</div>';
